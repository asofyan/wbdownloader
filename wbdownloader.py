...
async def main():
    ...
    try:
        ...
        async with AsyncDownloader(
            ...
            # Initialize download tracking and scan for existing files
                ...
                for page_info in pages_at_level:
                    ...
                    if not args.no_assets:
                        ...
                        if unique_page_assets:
                            ...
                            await downloader.download_assets(unique_page_assets)
            ...
            # Show statistics
            if hasattr(downloader, 'downloaded') and hasattr(downloader, 'skipped'):
